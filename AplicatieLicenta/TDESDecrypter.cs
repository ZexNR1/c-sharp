...
{
    public partial class TDESDecrypter : Form
    {
        public TDESDecrypter()
        {
            InitializeComponent();
        }
        ...
        public void Decriptare3DES(string text, string key)
        {
            ...
            using(MD5CryptoServiceProvider md5=new MD5CryptoServiceProvider())
            {
                ...
                using(TripleDESCryptoServiceProvider tdes=new TripleDESCryptoServiceProvider() {Key=keys,Mode=CipherMode.ECB,Padding=PaddingMode.PKCS7})
                {
                    ...
                    this.textBox3.Text=UTF8Encoding.UTF8.GetString(result);
                }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (this.textBox1.Text != "" && this.textBox2.Text != "")
            {
                ...
                Decriptare3DES(this.textBox1.Text, this.textBox2.Text);
            }
